  ...
  return (
    <div className="min-h-screen bg-[#E4E3E0] text-[#141414] font-sans flex flex-col relative overflow-x-hidden">
      ...
      {gameState.currentCombatInView ? (
        ...
        /* STANDARD VIEWPORT */
        <main className="flex-1 p-4 grid grid-cols-1 lg:grid-cols-12 gap-4 items-stretch overflow-hidden">
          ...
          {/* Right Column (3/12): Realtime Boardroom Feed */}
          <section className="lg:col-span-3 bg-[#D4D3D0] border-4 border-[#141414] p-4 flex flex-col gap-3 overflow-hidden h-[540px] lg:h-auto shadow-[4px_4px_0px_0px_#141414]">
