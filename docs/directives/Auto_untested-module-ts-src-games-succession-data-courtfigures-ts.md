# ts/src/games/succession/data/courtFigures.ts has no tests while its neighbours do
...
```
ts/src/games/succession/data/courtFigures.ts
```
...
`ts/src/games/succession/data/courtFigures.ts` has no tests, while other modules in the same folder do. Read it, then write
...
| Base branch | - |
| Base commit | 22685544dafebffa375b1845e14789a22303eb91 |
