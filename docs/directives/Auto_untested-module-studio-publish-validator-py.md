# studio/publish_validator.py has no tests while its neighbours do
...
`studio/publish_validator.py` has no tests, while other modules in the same folder do. Read it, then write
...
**Status log**
- 2026-09-20 13:00 · backlog-policy · none → Queued — generated from a untested-module finding authorised in backlog_policy.yaml
