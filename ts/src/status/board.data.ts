...
export const STATUS_BOARD: ProjectEntry[] = [
  ...
  { id: 'slimegarden', name: 'SlimeGarden', category: 'ai_studio_track', status: 'status_unconfirmed', currentState: 'Substantial design work as of mid-July (SlimeDex, Life Stages, partial Color Tree).', nextAction: 'Direct status check needed.', lastUpdated: '2026-08-15', verificationMethod: 'research/inference' },
  { id: 'trinity_siege', name: 'Trinity Siege/Combat', category: 'ai_studio_track', status: 'status_unconfirmed', currentState: 'Bevy vs. egui architecture question left unresolved.', nextAction: 'Direct status check — no longer blocked on the Rust-chassis question, that is confirmed Far Future Dream now.', lastUpdated: '2026-08-15', verificationMethod: 'research/inference' },
  { id: '7_days_to_fry', name: '7 Days to Fry', category: 'ai_studio_track', status: 'status_unconfirmed', currentState: 'Imported alongside KingMaker Squads (now retired). No status since.', nextAction: 'Direct status check needed.', lastUpdated: '2026-08-15', verificationMethod: 'research/inference' },
  { id: 'turboshells', name: 'TurboShells', category: 'ai_studio_track', status: 'status_unconfirmed', currentState: 'Named as a genuine cross-language-origin Lua exception (with VoidDrift). No recent confirmation.', nextAction: 'Direct status check needed.', lastUpdated: '2026-08-15', verificationMethod: 'research/inference' },
