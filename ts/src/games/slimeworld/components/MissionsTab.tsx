...
type MissionSubTab = 'mediation' | 'exploration' | 'active' | 'zones';
...
export function MissionsTab(props: MissionsTabProps) {
  const [activeSubTab, setActiveSubTab] = useState<MissionSubTab>('active');

  return (
    <div className="flex flex-col flex-1">
      <TabBar
        tabs={[{ id: 'active', label: 'ACTIVE' }, { id: 'zones', label: 'ZONES' }, { id: 'mediation', label: 'MEDIATION' }, { id: 'exploration', label: 'EXPLORATION' }]}
        active={activeSubTab}
