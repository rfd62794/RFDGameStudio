...
export interface LabState {
  ...
  accentTargetCodex?: Record<string, boolean>;
  ...
  hasReceivedFirstBreedReward?: boolean;
  lastSeedPurchaseCycle?: number;
}
...
export function luaSlimeToTs(raw: Raw): Slime {
  ...
  return {
    ...
    matchedAccentTargetIds: array(raw['matched_accent_target_ids']) as string[],
