  ...
  return (
    ...
    >
      <div className="space-y-3">
        <button
          id="audience-approach-toggle-evidence"
          type="button"
          onClick={onToggle}
          aria-expanded={isExpanded}
          className={`w-full flex items-center justify-between gap-3 pb-3 text-left cursor-pointer ${isExpanded ? 'border-b border-stone-800' : ''}`}
        >
        ...
        {isExpanded && (playerEvidence.length > 0 ? (
          <div className="space-y-3">
